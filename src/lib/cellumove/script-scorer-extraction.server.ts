...
function buildPrompt(input: {
  ...
  return [
    ...
    "Use only the supplied taxonomy codes and their corresponding layers.",
    ...
    "Required line shape: {scriptModuleId,lineIndex,text,layer,code,otherExplanation?,concreteSpans:[{text,kind}],factualAssertions:[{quote,normalizedClaim,claimType}]}",
