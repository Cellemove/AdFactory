---
name: "source-command-give-commit-message"
description: "PR title and description for the current changes — clean, non-technical, big changes only"
---

# source-command-give-commit-message

Use this skill when the user asks to run the migrated source command `give-commit-message`.
